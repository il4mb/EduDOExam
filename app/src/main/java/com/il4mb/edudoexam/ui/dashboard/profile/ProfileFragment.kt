...
class ProfileFragment : BaseFragment<FragmentProfileBinding>(FragmentProfileBinding::class.java) {
    ...
    override fun onCreateMenuItems(): MutableList<MenuLayout.MenuItem> {
        ...
        val menuItems = mutableListOf<MenuLayout.MenuItem>()
        menuItems.add(MenuLayout.MenuItem(requireContext()).apply {
            setImageDrawable(R.drawable.img_edit)
            setOnClickListener {
                findNavController().navigate(R.id.action_nav_profile_to_nav_profile_edit)
            }
        })
        menuItems.add(MenuLayout.MenuItem(requireContext()).apply {
            setImageDrawable(R.drawable.img_logout)
            setOnClickListener {
            ...
            user.observe(viewLifecycleOwner) {
                lifecycleScope.launch {
                    binding.apply {
                        ...
                        userEmailView.text = it?.email
                        if(it != null) UiHelper.setupUserImage(requireContext(), userPhotoView, it)
