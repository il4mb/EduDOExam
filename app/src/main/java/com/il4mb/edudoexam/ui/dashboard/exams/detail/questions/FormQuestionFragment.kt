...
import com.il4mb.edudoexam.databinding.FragmentFormQuestionBinding
import com.il4mb.edudoexam.models.QuestionOptions
import com.il4mb.edudoexam.ui.dashboard.exams.detail.questions.steps.Step1
import com.il4mb.edudoexam.ui.dashboard.exams.detail.questions.steps.Step2
import com.il4mb.edudoexam.ui.dashboard.exams.detail.questions.steps.Step3
import com.il4mb.edudoexam.ui.dashboard.exams.detail.questions.steps.Step4

class FormQuestionFragment : BaseFragment<FragmentFormQuestionBinding>(FragmentFormQuestionBinding::class.java) {

    class FormQuestionAdapter(formQuestionFragment: FormQuestionFragment): FragmentStateAdapter(formQuestionFragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            viewPager.apply {
                adapter = FormQuestionAdapter(this@FormQuestionFragment)
                registerOnPageChangeCallback(
                    object : ViewPager2.OnPageChangeCallback() {
                        override fun onPageSelected(position: Int) {
                            super.onPageSelected(position)
                            stepsIndicator.currentStep = position
                        }
                    }
                )
            }
...
//        if(result) {
//            cropImage(requireContext(), uri, 3, 2) {
//                if(it != null) imageUri = getRealPathFromUri(it)
//            }
//            validateForm()
//        }
//    }
...
//                formState.imageUri = imageUri
//                formState.options = binding.optionsLayout.options.asMap()
//                formState.correctOption = correctOption
//            }
//            .fetch {
//                it.addQuestion(
//                    examId!!,
